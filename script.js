...
"半永久統制マトリックス","風蝕ウェネト","深罪の浸礼者","鉄甲熔炎帝王", "氷風組曲", "千年真珠の海駿", "実験用フィールド生成装置", "水形タルパ", "アンドリアス","山隠れの猊獣"];

// BOSS2の配列
const BOSS2 = ["無相の雷","無相の風","無相の岩","純水精霊","急凍樹","爆炎樹","エンシェントヴィシャップ","無相の氷","魔偶剣鬼","恒常からくり陣形",
"無相の炎","無相の水","雷音権現","黄金王獣","アビサルヴィシャップ","遺跡サーペント","マッシュラプトル","迅電樹","兆載永劫ドレイク",
"半永久統制マトリックス","無相の草","風蝕ウェネト","深罪の浸礼者","鉄甲熔炎帝王", "氷風組曲", "千年真珠の海駿", "実験用フィールド生成装置", "水形タルパ", "アンドリアス","山隠れの猊獣"];
...
"水形タルパ", "アンドリアス","山隠れの猊獣","タルタリヤ","若陀龍王","淑女","雷電将軍","マシュ","アペプ", "呑星の鯨"];
